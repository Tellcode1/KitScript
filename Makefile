...
SOURCES=ast.c ast.free.c lex.c var.c list.c map.c bfunc.c bfunc.str.c bfunc.list.c bfunc.io.c bfunc.sys.c bfunc.math.c bfunc.rand.c pool.c ldfile.c validate.c stackemu.c stack.c arena.c
